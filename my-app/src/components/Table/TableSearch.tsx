...
export default function TableSearch() {
  ...
  return (
    <div className="flex justify-center items-center w-full h-10 rounded-lg border-solid border-2 border-gray-200">
      ...
      {filteredWords.map((word, index) => (
        <span key={index} className="mx-1 bg-gray-200 p-1 rounded-lg text-sm">
          {word}
          <AiFillCloseCircle
