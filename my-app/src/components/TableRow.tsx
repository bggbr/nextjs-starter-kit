        ...
        <>
            <tr className='min-h-20'>
                ...
                <td className='p-3 text-center'>
                    <button
                        className='mr-3 px-4 py-2 rounded-full bg-yellow-500 cursor-pointer text-white font-bold'
                        key='edit'
                    ...
                    <button
                        className='px-4 py-2 rounded-full bg-yellow-500 cursor-pointer text-white font-bold'
                        key='delete'
